...
<html>
 <head>
  ...
  <script type="text/javascript">	//无刷新上传图片
	...
	function SetIframeHeight(iframename) {	//upload_target iframe自适应高度脚本
          var iframeid = document.getElementById('upload_target'); //iframe id
		...
		<div id="main">
			...
			<div id="mainbody">	<!-- 中间主体区 -->
			    <div id="sendpost">		<!-- 发布内容输入框 -->
					...
					<iframe id="upload_target" name="upload_target" frameborder="0" scrolling="no"  onload="javascript:{SetIframeHeight('upload_target');}" src=""><form action="upload_file.php" method="post" enctype="multipart/form-data" target="upload_target">
					<input type="file" name="file" id="file"/> 
					<input type="submit" name="submit" value="Submit" />
					</form></iframe><br />
